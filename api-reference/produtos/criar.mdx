...
<ParamField body="pixAutomatic" type="boolean" default="true">
  Habilita o [Pix Automático](/guias/pix-automatico) (débito recorrente do Pix) no checkout de assinatura do produto. **Vem ligado por padrão** — envie `false` para não oferecer. Produtos que não são assinatura ignoram o campo.
</ParamField>
