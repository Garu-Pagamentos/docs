...
const response = await fetch(
  'https://api.garu.com.br/api/transactions/status/987654'
);
...
url = "https://api.garu.com.br/api/transactions/status/987654"
...
async function isPaid(galaxPayId) {
  const response = await fetch(
    `https://api.garu.com.br/api/transactions/status/${galaxPayId}`
  );
