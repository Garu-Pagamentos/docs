...
<Note>
  A partir da **v0.10.0**, `{productId}` aceita tanto o UUID do produto quanto o id numérico legado. UUID é o caminho recomendado — é o identificador estável retornado por `GET /api/products/seller` e `list_products`.
</Note>
