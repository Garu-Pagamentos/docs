...
```bash
curl -X GET https://garu.com.br/api/products/seller \
...
const response = await fetch('https://garu.com.br/api/products/seller', {
  headers: {
...
response = requests.get(
    'https://garu.com.br/api/products/seller',
    headers=headers
)
```
...
$ch = curl_init('https://garu.com.br/api/products/seller');
