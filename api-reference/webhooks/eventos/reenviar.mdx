...
Reseta o evento para `pending`, zera o contador de tentativas falhas e dispara a entrega imediatamente. Funciona em qualquer status (`success`, `failed`, `pending`) — o mesmo botão "Reenviar" do dashboard, agora disponível na API.
