...
<Note>
  A CLI ainda não tem um grupo de comandos para clientes. Cadastre e gerencie clientes pelo dashboard (`/clientes`) ou pela API — veja [Cadastro de clientes](/guias/clientes).
</Note>
